"""Tiny sequence model with an LSTM — next-char prediction over text.
...
Architecturally mirrors char_lm but with a much smaller embedding and hidden
size — meant as the minimal "does training even run?" example.
...
LABEL = "LSTM Sequence Model (Tiny)"
DESCRIPTION = "Minimal sequence LSTM. Marker-based — dataset lives in the panel."
